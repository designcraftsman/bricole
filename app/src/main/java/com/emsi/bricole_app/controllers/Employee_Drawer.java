...
public class Employee_Drawer extends AppCompatActivity {
    ...
    protected void setupDrawer(int layoutResID) {
        DrawerLayout fullLayout = (DrawerLayout) getLayoutInflater().inflate(R.layout.employee_drawer_layout, null);
